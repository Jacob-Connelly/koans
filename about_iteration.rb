...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Iterates through the array passing the accumlator value into the first argument and the array value as second argument, then returning the following statement
  end
  ...
  # So we can go straight into iterating through the lines, or because it changes the return type perhaps :shrug:
